...
|:-:|---|---|
| 07/18/2017 | Project 1  | Research Design Write-Up   |
...
#### Dataset  
We'll be using the [Titanic](https://www.kaggle.com/c/titanic) dataset to explore Logistic Regression in Python. A GREAT resource for Logistic Regression may be found on
 [yhat's blog](http://blog.yhat.com/posts/logistic-regression-and-python.html). This is an excellent resource for using logistic regression and summary statistics to explore a relevant dataset. 
 
 Our goal will be to identify the various factors that influenced survival status of passengers on the Titanic. As you know the dataset contains the survival status, passenger class, gender, age, family information, ticket number, paid fair, cabin number and port of embarkation for each passenger.
 
 Why study the Titanic data set? We study the Titanic data set in depth because it, along with Iris, and a few other data sets are considered benchmarks for classification algorithms! 
...
* Starter Code will go live tonight 07/06/17.
